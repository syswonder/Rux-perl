...
"aarch64-linux-6.3.13-linuxkit" or
	die "Errno architecture (aarch64-linux-6.3.13-linuxkit) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
